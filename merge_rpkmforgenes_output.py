...
class GenemismatchException(Exception): pass
...
if '__main__' == __name__:
	...
	opts.add_argument('--skiperrorfiles', action='store_true')
	o = opts.parse_args()
		...
		with open(inf, 'r') as infh:
			try:
				...
				if numgenes is None:
					...
					raise GenemismatchException, 'Unequal number of genes between files'
			except GenemismatchException:
				if o.skiperrorfiles: continue
				else: raise
